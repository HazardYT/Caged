...
public class InGameSettingsMenu : MonoBehaviourPun
{
    ...
    public void menuon()
    {
        ...
        else{this.transform.root.GetComponent<PlayerMovement>().enabled = false;}
    ...
    public void menuoff()
    {
        ...
        else{this.transform.root.GetComponent<PlayerMovement>().enabled = true;}
